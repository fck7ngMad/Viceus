...
// Слушатели
NEXT__BUTTON.addEventListener('click', nextButtonEvent);

PREV__BUTTON.addEventListener('click', prevButtonEvent);


// Гамбургер для меню
const humburger = document.querySelector(".humburger");
const navLinks = document.querySelector(".menu__list-body");
const links = document.querySelectorAll(".menu__list-body .menu__list");
